...
namespace Softklin.Mastermind
{
    ...
    {   
        /// <summary>
        /// Initializes a new instance of the MastermindBoardEsception class.
        /// </summary>
        public MastermindBoardException() { }
        /// <summary>
        /// Initializes a new instance of the MastermindBoardEsception class with a specified error message.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        public MastermindBoardException(string message) : base(message) { }
        /// <summary>
        /// Initializes a new instance of the MastermindBoardEsception class with a specified error message and a reference to the inner exception that is the cause of this exception.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the MastermindBoardEsception class with serialized data.
        /// </summary>
    ...
    /// </summary>
    [Serializable]
    public class MastermindColoredPegRowException : Exception
    {
        /// <summary>
